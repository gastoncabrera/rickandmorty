      ...
      <div>
        <ul class="social-icon">
          <li class="social-icon-list">
            ...
            >
              <svg
                stroke="rgb(155, 158, 158)"
                fill="rgb(155, 158, 158)"
                stroke-width="0"
                viewBox="0 0 16 16"
                class=""
                height="1.1em"
          ...
          <li>
            <a
              ...
              rel="nofollow noopener noreferrer"
              target="_blank"
              class="externalLink__ExternalLink-sc-1lixk38-0 bQJGkk"
            >
              <svg
                stroke="rgb(155, 158, 158)"
                fill="rgb(155, 158, 158)"
          ...
          <li>
            <a title="Help Us" aria-label="help us" href="/help-us">
              <svg
                stroke="rgb(155, 158, 158)"
                fill="rgb(155, 158, 158)"
                stroke-width="0"
